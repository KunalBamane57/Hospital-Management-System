    ...
    <div className="space-y-6 animate-fade-in max-w-2xl">
      ...
      <Card className="border-0 shadow-sm">
        ...
        <CardContent className="space-y-4">
          {[
            { label: "New Appointment Alerts", desc: "Get notified when patients book appointments", defaultChecked: true },
            { label: "Email Notifications", desc: "Receive booking confirmations via email", defaultChecked: true },
            { label: "SMS Notifications", desc: "Receive text message alerts for urgent bookings", defaultChecked: false },
            { label: "Review Alerts", desc: "Get notified when patients leave reviews", defaultChecked: true },
            { label: "Daily Summary", desc: "Receive a daily summary of appointments", defaultChecked: true },
          ].map((item) => (
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between rounded-xl border p-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Allow patients to find you in search</p>
            </div>
